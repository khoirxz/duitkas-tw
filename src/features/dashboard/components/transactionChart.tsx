...
export default function TransactionChart({ data }: TransactionChartProps) {
  ...
  return (
    <div className="flex flex-col h-full gap-4">
      ...
      {data.pemasukan.data.length > 0 && data.pengeluaran.data.length > 0 ? (
        <>
          ...
          <div className="space-y-1 flex-1">
            ...
            <div className="relative">
              <div
                className="space-y-2.5 max-h-[240px] md:max-h-[190px] overflow-y-auto snap-x snap-mandatory relative scroll-smooth"
                ref={scrollRef}
...
function DonutChart({
  ...
  return (
    <div className="w-30 h-30 md:w-40 md:h-40 mx-auto">
      <ChartContainer
        config={chartConfig}
        className="mx-auto aspect-square w-full h-full md:max-h-[160px] md:max-w-[160px]">
